...
export default function Pagenation({totalPages, pageSize}) {
  ...
  return (
    <div className={style.frame}>
        ...
        {getPageNumber(totalPages, pageSize)[start].map( page => 
            <PageNumber key={page} onClick={selectPage}>{page.page}</PageNumber>
        )}
